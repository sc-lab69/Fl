...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // 3. Setup Block Category Filter
  setupBlockExplorer();

  // 4. Setup Interactive Quiz
  setupQuiz();

  // 5. Setup Sound Toggle Button
  setupSoundToggle();

  // 6. Setup Asset Download Generator
  setupAssetDownload();
});
...
function switchTab(tabId) {
  ...
  // If switched to mini-game, trigger resize
